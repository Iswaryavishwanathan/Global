package com.example.global.DAO.FourthDAO;
...
public class FourthDAO {
    ...
    public FourthDAO(LocalDateTime dateAndTime, int millitm, Integer tagIndex, String tagName, double val, String status, String marker, String databaseSource) {
