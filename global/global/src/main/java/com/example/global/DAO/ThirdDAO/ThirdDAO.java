package com.example.global.DAO.ThirdDAO;
...
public class ThirdDAO {
    ...
    public ThirdDAO(LocalDateTime dateAndTime, int millitm, Integer tagIndex, String tagName, double val, String status, String marker, String databaseSource) {
