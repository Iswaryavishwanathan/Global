package com.example.global.DAO.PrimaryDAO;
...
public class PrimaryDAO {
    ...
    public PrimaryDAO(LocalDateTime dateAndTime, int millitm, Integer tagIndex, String tagName, double val, String status, String marker, String databaseSource) {
